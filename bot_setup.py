...
def add_store_from_list(item_name, item_desc, item_price, in_buhinet, usable, item_function):
    ...
    if item == []:
        ...
        cur.execute(""" UPDATE store_data
                        ...
                        WHERE item_name=?""", (item_name, item_desc, item_price, in_buhinet, usable, item_function, item_name))
...
def add_items(item_list):
    for item in item_list:
        ...
        add_store_from_list(item_name, item_desc, item_price, in_buhinet, usable, item_function)
...
def create_tables():
    ...
    cur.execute(""" CREATE TABLE IF NOT EXISTS user_data(
                    user_id integer,
                    balance integer)""")
    cur.execute(""" CREATE TABLE IF NOT EXISTS store_data(
                    item_name text,
                    item_desc text,
                    item_price integer,
                    in_buhinet bit,
